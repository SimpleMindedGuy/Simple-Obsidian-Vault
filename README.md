...
Look up the [Utility documentation](./99-Templates/Utility documentation.md) for the Script for more information on what commands do, If you have any suggestions for commands, please create an issue ticket for it, preferably with an `enhancement` label.
...
But currently it only works for data that is collected from periodic notes, Read the [Habit Tracking Documentation](99-Templates/Habit Tracking Documentation.md) for more information, and understand how it works.

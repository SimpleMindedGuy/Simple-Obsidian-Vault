...
async function GetMediaFileLinks(File) {
  ...
  if (!tp) {
    console.warn(`04-Reading-Text: GetMediaFilesLinks:\ntemplater is not provided`)
    console.warn(tp)
    return null
  }


  console.log(`04-Reading-Text: GetMediaFilesLinks:\nGetting media Link from file\n@:${File.path}`);
...
module.exports = GetMediaFileLinks

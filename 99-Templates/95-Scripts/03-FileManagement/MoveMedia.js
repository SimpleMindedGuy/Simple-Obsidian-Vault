...
async function MoveMedia(file,path,isNumbered,padding=2)
{
    ...
    if(!tp)
    {
        console.warn(`06-Utility Specific: MoveMedia:\ntemplater is not provided`)
        console.warn(tp)
        return
    }
    ...
    let BuildDirectory = await tp.user.MakeBuildPath(tp,BuildRoot,BuildList,false,false)

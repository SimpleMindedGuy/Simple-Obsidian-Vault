 ...
 * Then it asks the user to choose tempaltes depending on which template the user is using.
 ...
 * - {@link MakeOverview} Tells the script to wether or not to make an Overview File
...
async function BuildDocument(BuildOptions){
    ...
    if(HasDirectory)
    {
        ...
        if(isDirectoryNumbered)
        {
            ...
            DocumentName = `${DocumentNumber}-${Meta[titleKey]}`;
        }
